...
const DateRangePicker: React.FC<DateRangePickerProps> = ({
  ...
  return (
    <div className="w-full">
      {label && (
        <label className="block text-sm font-medium text-secondary-800 dark:text-secondary-200 mb-2">
          {label}
        </label>
      )}
      <div className="relative">
        <button
          ...
          className={`${className} w-full px-4 py-3 text-left border border-secondary-300 dark:border-secondary-600 bg-white dark:bg-dark-card text-secondary-900 dark:text-dark-text placeholder-secondary-500 dark:placeholder-secondary-400 rounded-xl cursor-pointer hover:border-primary-500 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed`}
        >
          <span className={value?.from ? "text-secondary-900 dark:text-dark-text" : "text-secondary-500 dark:text-secondary-400"}>
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl border-0 p-4 min-w-[320px]">
                <DayPicker
                  ...
                  classNames={{
                    ...
                    day_range_middle:
                      "aria-selected:bg-blue-100 dark:aria-selected:bg-blue-900/20 aria-selected:text-blue-700 dark:aria-selected:text-blue-300",
                  }}
                />
              </div>
            </div>
