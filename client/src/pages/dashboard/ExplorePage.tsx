    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <PlacesAutocomplete
          ...
          className="w-full py-4 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 shadow-sm text-lg"
        />
