#!/usr/bin/env python3
"""
Fix collaborator with proper ObjectId conversion
"""
...
async def fix_collaborator_objectid():
    try:
        await Database.connect_db()
        db = Database.client.SafarBot
        
        print("🔧 Fixing Collaborator with ObjectId")
        print("=" * 50)
        
        # The correct user ID from user_fields collection
        correct_user_id = ObjectId("6894590d0368e75cd399fedb")
        ...
        result2 = await db.saved_itineraries.update_one(
            {'_id': ObjectId("68bdd89cb42ce03606c68566")},
            {'$set': {
...
if __name__ == "__main__":
    asyncio.run(fix_collaborator_objectid())
